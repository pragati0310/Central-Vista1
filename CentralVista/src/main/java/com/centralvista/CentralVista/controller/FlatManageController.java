...
import com.centralvista.CentralVista.repository.FlatManageRepository;
...
public class FlatManageController {
	@Autowired
	@Qualifier("flatmngRepo")
	FlatManageRepository flatmngRepo;
	...
	public ArrayList<FlatManage> getAll()
	{
		ArrayList<FlatManage> ls=(ArrayList<FlatManage>)flatmngRepo.findAll();
		return ls;
		
	}
	@PostMapping(value= {"/flatmng"},consumes= {MediaType.MULTIPART_FORM_DATA_VALUE})
	public FlatManage insertrecord(@RequestPart("flatmng") FlatManage e,@RequestPart("imageFile") MultipartFile[] files)
	{
		try {
